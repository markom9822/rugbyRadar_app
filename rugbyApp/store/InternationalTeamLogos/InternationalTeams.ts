...
export const AustraliaAltLogo = require('@/store/InternationalTeamLogos/Australia_Rugby_Logo_White.png')

export const WalesLogo = require('@/store/InternationalTeamLogos/Welsh_Rugby_Union_logo.png')
export const WalesAltLogo = require('@/store/InternationalTeamLogos/Wales_Rugby_Logo_White.png')

export const FranceLogo = require('@/store/InternationalTeamLogos/France_Rugby_logo.png')
export const FranceAltLogo = require('@/store/InternationalTeamLogos/France_Rugby_White_Logo.png')

export const ScotlandLogo = require('@/store/InternationalTeamLogos/Scotlandlogo.png')
export const ScotlandAltLogo = require('@/store/InternationalTeamLogos/Scotland_Logo_White.png')

export const ArgentinaLogo = require('@/store/InternationalTeamLogos/Los_pumas_argentina_logo.png')
export const ArgentinaAltLogo = require('@/store/InternationalTeamLogos/Los_Pumas_Logo_White.png')
...
export const JapanAltLogo = require('@/store/InternationalTeamLogos/Japan_Rugby_Logo_White.png')
...
export const CanadaAltLogo = require('@/store/InternationalTeamLogos/Canada_Rugby_Logo_White.png')

export const USALogo = require('@/store/InternationalTeamLogos/United_States_national_rugby_union_team_logo.png')
export const USAAltLogo = require('@/store/InternationalTeamLogos/USA_Rugby_Logo_White.png')
...
export const TongaAltLogo = require('@/store/InternationalTeamLogos/Tonga_Rugby_Logo_White.png')

export const SamoaLogo = require('@/store/InternationalTeamLogos/Logo_Samoa_Rugby.png')
export const SamoaAltLogo = require('@/store/InternationalTeamLogos/Samoa_Rugby_Logo_White.png')

export const RomaniaLogo = require('@/store/InternationalTeamLogos/Romania_national_rugby_union_team_logo.png')
export const RomaniaAltLogo = require('@/store/InternationalTeamLogos/Romania_Rugby_Logo_White.png')

export const SpainLogo = require('@/store/InternationalTeamLogos/Spain_Rugby_logo.png')
export const SpainAltLogo = require('@/store/InternationalTeamLogos/Spain_Rugby_Logo_White.png')
...
export const HongKongLogo = require('@/store/InternationalTeamLogos/Hong_Kong_Logo.png')
export const HongKongAltLogo = require('@/store/InternationalTeamLogos/Hong_Kong_Logo_White.png')

export const ZimbabweLogo = require('@/store/InternationalTeamLogos/Zimbabwe_Logo.png')
export const ZimbabweAltLogo = require('@/store/InternationalTeamLogos/Zimbabwe_Logo_White.png')
